					...
					<div class="col-md-12">
                        <div class="categories">
                            <div class="categories-title">
                                ...
                                <p>If you already have an account with us, please login at the <a href="loginuser.php">login page</a>.</p> <br>
                            </div>
                            <form action="registeruser_code.php" method="post" id="registrationform">
								<div class="row">
					 				<div class="col-md-3">
