...
function docReady() {
    ...
    /*$('ul.gallery li').hover(function () {
		...
		var a = $(this).find('.notification1').text();
        $(this).append('<div class="well gallery-controls">' +
            '<p><a href="icon.html?id='+a+'" class="gallery-edit btn"><i class="glyphicon glyphicon-edit"></i></a> <a href="manage_table.php" class="gallery-delete btn"><i class="glyphicon glyphicon-info-sign"></i></a></p>' +
            '</div>');
