    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
            	<?php
					$query="select * from tbl_gallery where g_type=2";
                ...
                <table id="txtHint" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="../images/gallery/door/<?php echo $row['g_img']; ?>" width="220px" height="150px" ></td>
                            <td class="center">
                                <a class="btn btn-danger" href="gallery_delete.php?id=<?php echo $row['g_id']; ?>&g_id=2">
