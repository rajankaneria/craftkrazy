    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Door</h2>
            ...
            <div class="box-content">
            	<?php
					$query="select * from tbl_photo where g_type=2";
                ...
                <table id="txtHint" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="center">
                                <a class="btn btn-danger" href="photo_delete.php?id=<?php echo $row['photo_id']; ?>&g_id=2">
