    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                <form role="form" action="gallery_add_code.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                    	<div class="col-md-3">
                        ...
                        <div class="col-md-3">
           					<div class="control-group">
                                <label class="control-label" for="selectError">Select Page:- </label>
            
                                <div class="controls">
                                    <select id="selectError" data-rel="chosen" name="page">
                                    	<?php
											$query1="select * from tbl_p_type";
											$sql1=mysql_query($query1) or die("Error in Query1");
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="file" name="photo[]" class="form-control" id="exampleInputEmail1" multiple>
                            </div>
                        </div>
                    </div>
