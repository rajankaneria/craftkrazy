    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Clients</h2>
                ...
                <table id="txtHint" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="../images/clients/<?php echo $row['client_img']; ?>" width="220px" height="150px" ></td>
                            <td class="center">
                                <a class="btn btn-danger" href="cli_delete.php?id=<?php echo $row['client_id']; ?>">
