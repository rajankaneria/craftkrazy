    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
            	<?php
					$query="select * from tbl_gallery where g_type=1";
                ...
                <table id="txtHint" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
								<?php 
									$query1="select * from tbl_p_type where pt_id=".$row['p_type'];
									$sql1=mysql_query($query1) or die("error in query1");
									$row1=mysql_fetch_array($sql1);
									echo $row1['pt_name']; 
								?>
                            </td>
                            <td><img src="../images/gallery/sleek/<?php echo $row['g_img']; ?>" width="220px" height="150px" ></td>
                            <td class="center">
                                <a class="btn btn-danger" href="gallery_delete.php?id=<?php echo $row['g_id']; ?>&g_id=1">
